...
//cyclePrompt method - 3.next cycleprompt function is called
function cyclePrompt() {
    console.log('-------Welcome to the file gen app!----------');
    inquirer.prompt([
        {
...
//2. from index.js it calls the cyclePrompt below next it goes to cycleprompt function line 136 - when we share multiple exports then use object - shown below
module.exports = {
    cyclePrompt: cyclePrompt, //cyclePrompt has method set that to cyclePrompt function above because methods are functions & functions are methods
    promptUser: promptUser
};
